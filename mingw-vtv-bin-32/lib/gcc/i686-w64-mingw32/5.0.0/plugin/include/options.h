...
#endif
#ifdef GENERATOR_FILE
extern enum fgraphite_generator flag_graphite_code_gen;
#else
  enum fgraphite_generator x_flag_graphite_code_gen;
#define flag_graphite_code_gen global_options.x_flag_graphite_code_gen
#endif
#ifdef GENERATOR_FILE
...
#define OPTION_MASK_ISA_AVX512PF (HOST_WIDE_INT_1 << 15)
#define OPTION_MASK_ISA_AVX512VL (HOST_WIDE_INT_1 << 16)
#define OPTION_MASK_ISA_BMI (HOST_WIDE_INT_1 << 17)
#define OPTION_MASK_ISA_BMI2 (HOST_WIDE_INT_1 << 18)
#define MASK_CLD (1 << 8)
#define OPTION_MASK_ISA_CLFLUSHOPT (HOST_WIDE_INT_1 << 19)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1 << 20)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1 << 21)
#define OPTION_MASK_ISA_F16C (HOST_WIDE_INT_1 << 22)
#define MASK_NO_FANCY_MATH_387 (1 << 9)
#define OPTION_MASK_ISA_FMA (HOST_WIDE_INT_1 << 23)
#define OPTION_MASK_ISA_FMA4 (HOST_WIDE_INT_1 << 24)
#define MASK_FLOAT_RETURNS (1 << 10)
#define OPTION_MASK_ISA_FSGSBASE (HOST_WIDE_INT_1 << 25)
#define OPTION_MASK_ISA_FXSR (HOST_WIDE_INT_1 << 26)
#define OPTION_MASK_ISA_HLE (HOST_WIDE_INT_1 << 27)
...
#define OPTION_MASK_ISA_LWP (HOST_WIDE_INT_1 << 28)
#define OPTION_MASK_ISA_LZCNT (HOST_WIDE_INT_1 << 29)
#define OPTION_MASK_ISA_MMX (HOST_WIDE_INT_1 << 30)
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1 << 31)
#define MASK_MS_BITFIELD_LAYOUT (1 << 16)
#define MASK_NO_PUSH_ARGS (1 << 17)
#define MASK_NO_RED_ZONE (1 << 18)
#define OPTION_MASK_ISA_SSE4_1 (HOST_WIDE_INT_1 << 32)
#define MASK_OMIT_LEAF_FRAME_POINTER (1 << 19)
#define OPTION_MASK_ISA_PCLMUL (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_ISA_POPCNT (HOST_WIDE_INT_1 << 34)
#define MASK_PREFER_AVX128 (1 << 20)
#define OPTION_MASK_ISA_PREFETCHWT1 (HOST_WIDE_INT_1 << 35)
#define OPTION_MASK_ISA_PRFCHW (HOST_WIDE_INT_1 << 36)
#define OPTION_MASK_ISA_RDRND (HOST_WIDE_INT_1 << 37)
#define OPTION_MASK_ISA_RDSEED (HOST_WIDE_INT_1 << 38)
#define MASK_RECIP (1 << 21)
#define MASK_RTD (1 << 22)
#define OPTION_MASK_ISA_RTM (HOST_WIDE_INT_1 << 39)
#define OPTION_MASK_ISA_SAHF (HOST_WIDE_INT_1 << 40)
#define OPTION_MASK_ISA_SHA (HOST_WIDE_INT_1 << 41)
#define OPTION_MASK_ISA_SSE (HOST_WIDE_INT_1 << 42)
#define OPTION_MASK_ISA_SSE2 (HOST_WIDE_INT_1 << 43)
#define OPTION_MASK_ISA_SSE3 (HOST_WIDE_INT_1 << 44)
#define OPTION_MASK_ISA_SSE4_2 (HOST_WIDE_INT_1 << 45)
#define OPTION_MASK_ISA_SSE4A (HOST_WIDE_INT_1 << 46)
#define MASK_SSEREGPARM (1 << 23)
#define OPTION_MASK_ISA_SSSE3 (HOST_WIDE_INT_1 << 47)
#define MASK_STACK_PROBE (1 << 24)
#define OPTION_MASK_ISA_TBM (HOST_WIDE_INT_1 << 48)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 25)
#define MASK_VECT8_RETURNS (1 << 26)
#define MASK_VZEROUPPER (1 << 27)
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1 << 49)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1 << 50)
#define OPTION_MASK_ISA_XSAVE (HOST_WIDE_INT_1 << 51)
#define OPTION_MASK_ISA_XSAVEC (HOST_WIDE_INT_1 << 52)
#define OPTION_MASK_ISA_XSAVEOPT (HOST_WIDE_INT_1 << 53)
#define OPTION_MASK_ISA_XSAVES (HOST_WIDE_INT_1 << 54)
...
enum opt_code
{
  ...
  OPT_Wbool_compare = 177,                   /* -Wbool-compare */
  ...
  OPT_Wconditionally_supported = 196,        /* -Wconditionally-supported */
  ...
  OPT_Wdate_time = 204,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 205,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 206,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 207,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdep_ann = 208,                        /* -Wdep-ann */
  OPT_Wdeprecated = 209,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 210,        /* -Wdeprecated-declarations */
  OPT_Wdesignated_init = 211,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 212,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_qualifiers = 213,           /* -Wdiscarded-qualifiers */
  OPT_Wdiscouraged = 214,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 215,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 216,               /* -Wdouble-promotion */
  OPT_Weffc__ = 217,                         /* -Weffc++ */
  OPT_Wempty_block = 218,                    /* -Wempty-block */
  OPT_Wempty_body = 219,                     /* -Wempty-body */
  OPT_Wendif_labels = 220,                   /* -Wendif-labels */
  OPT_Wenum_compare = 221,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 222,                /* -Wenum-identifier */
  OPT_Wenum_switch = 223,                    /* -Wenum-switch */
  OPT_Werror = 224,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 225, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 226,                         /* -Werror= */
  OPT_Wextra = 227,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 228,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 229,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 230,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 231,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 232,                    /* -Wfinal-bound */
  OPT_Wfinally = 233,                        /* -Wfinally */
  OPT_Wfloat_conversion = 234,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 235,                    /* -Wfloat-equal */
  OPT_Wforbidden = 236,                      /* -Wforbidden */
  ...
  OPT_Wformat_security = 241,                /* -Wformat-security */
  OPT_Wformat_signedness = 242,              /* -Wformat-signedness */
  OPT_Wformat_y2k = 243,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 244,             /* -Wformat-zero-length */
  OPT_Wformat_ = 245,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 246,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 247,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 248,           /* -Wfunction-elimination */
  OPT_Whiding = 249,                         /* -Whiding */
  OPT_Wignored_qualifiers = 250,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 251,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 252,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 253,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 254,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 255,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 256, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 257,     /* -Wincompatible-pointer-types */
  OPT_Windirect_static = 258,                /* -Windirect-static */
  ...
  OPT_Wint_to_pointer_cast = 263,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 264,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 265,             /* -Wintf-non-inherited */
  ...
  OPT_Wlocal_hiding = 278,                   /* -Wlocal-hiding */
  OPT_Wlogical_not_parentheses = 279,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 280,                     /* -Wlogical-op */
  OPT_Wlong_long = 281,                      /* -Wlong-long */
  OPT_Wmain = 282,                           /* -Wmain */
  OPT_Wmasked_catch_block = 283,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 284,            /* -Wmaybe-uninitialized */
  ...
  OPT_Wnls = 298,                            /* -Wnls */
  OPT_Wno_effect_assign = 299,               /* -Wno-effect-assign */
  ...
  OPT_Wout_of_date = 311,                    /* -Wout-of-date */
  OPT_Wover_ann = 312,                       /* -Wover-ann */
  ...
  OPT_Wparam_assign = 321,                   /* -Wparam-assign */
  OPT_Wparentheses = 322,                    /* -Wparentheses */
  OPT_Wpedantic = 323,                       /* -Wpedantic */
  OPT_Wpedantic_ms_format = 324,             /* -Wpedantic-ms-format */
  OPT_Wpkg_default_method = 325,             /* -Wpkg-default-method */
  ...
  OPT_Wredundant_modifiers = 339,            /* -Wredundant-modifiers */
  ...
  OPT_Wserial = 345,                         /* -Wserial */
  OPT_Wshadow = 346,                         /* -Wshadow */
  OPT_Wshadow_ivar = 347,                    /* -Wshadow-ivar */
  OPT_Wsign_compare = 348,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 349,                /* -Wsign-conversion */
  OPT_Wsign_promo = 350,                     /* -Wsign-promo */
  OPT_Wsizeof_array_argument = 351,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 352,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 353,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 354,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 355,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 356,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 357,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 358,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 359,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 360,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 361,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 362,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 363,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 364,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 365,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 366,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 367,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 368,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 369,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 370,            /* -Wsuggest-final-types */
  OPT_Wsuppress = 371,                       /* -Wsuppress */
  OPT_Wsurprising = 372,                     /* -Wsurprising */
  OPT_Wswitch = 373,                         /* -Wswitch */
  OPT_Wswitch_bool = 374,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 375,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 376,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 377,                      /* -Wsync-nand */
  OPT_Wsynth = 378,                          /* -Wsynth */
  OPT_Wsynthetic_access = 379,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 380,                 /* -Wsystem-headers */
  OPT_Wtabs = 381,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 382,                /* -Wtarget-lifetime */
  OPT_Wtasks = 383,                          /* -Wtasks */
  OPT_Wtraditional = 384,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 385,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 386,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 387,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 388,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 389,                    /* -Wtype-limits */
  OPT_Wuncheck = 390,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 391,            /* -Wundeclared-selector */
  OPT_Wundef = 392,                          /* -Wundef */
  OPT_Wunderflow = 393,                      /* -Wunderflow */
  OPT_Wuninitialized = 394,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 395,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 396,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 397,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 398, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 399,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 400,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 401,                         /* -Wunused */
  OPT_Wunused_argument = 402,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 403,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 404,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 405,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 406,                /* -Wunused-function */
  OPT_Wunused_import = 407,                  /* -Wunused-import */
  OPT_Wunused_label = 408,                   /* -Wunused-label */
  OPT_Wunused_local = 409,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 410,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 411,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 412,               /* -Wunused-parameter */
  OPT_Wunused_private = 413,                 /* -Wunused-private */
  OPT_Wunused_result = 414,                  /* -Wunused-result */
  OPT_Wunused_thrown = 415,                  /* -Wunused-thrown */
  OPT_Wunused_value = 416,                   /* -Wunused-value */
  OPT_Wunused_variable = 417,                /* -Wunused-variable */
  OPT_Wuse_without_only = 418,               /* -Wuse-without-only */
  ...
  OPT_Xlinker = 433,                         /* -Xlinker */
  OPT_Xpreprocessor = 434,                   /* -Xpreprocessor */
  OPT_Z = 435,                               /* -Z */
  OPT_ansi = 436,                            /* -ansi */
  OPT_aux_info = 437,                        /* -aux-info */
  /* OPT_aux_info_ = 438, */                 /* -aux-info= */
  OPT_auxbase = 439,                         /* -auxbase */
  OPT_auxbase_strip = 440,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 441, */             /* -bootclasspath */
  OPT_c = 442,                               /* -c */
  ...
  OPT_fPIE = 459,                            /* -fPIE */
  OPT_fRTS_ = 460,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 461,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 462,                   /* -fabi-version= */
  OPT_faccess_control = 463,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 464,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 465,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 466,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 467,                  /* -falign-commons */
  OPT_falign_functions = 468,                /* -falign-functions */
  OPT_falign_functions_ = 469,               /* -falign-functions= */
  OPT_falign_jumps = 470,                    /* -falign-jumps */
  OPT_falign_jumps_ = 471,                   /* -falign-jumps= */
  OPT_falign_labels = 472,                   /* -falign-labels */
  OPT_falign_labels_ = 473,                  /* -falign-labels= */
  OPT_falign_loops = 474,                    /* -falign-loops */
  OPT_falign_loops_ = 475,                   /* -falign-loops= */
  OPT_fall_intrinsics = 476,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 477, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 478,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 479,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 480, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 481, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 482, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 483, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 484, */  /* -fargument-noalias-global */
  OPT_fasm = 485,                            /* -fasm */
  OPT_fassert = 486,                         /* -fassert */
  OPT_fassociative_math = 487,               /* -fassociative-math */
  OPT_fassume_compiled = 488,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 489,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 490,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 491,                   /* -fauto-inc-dec */
  OPT_fautomatic = 492,                      /* -fautomatic */
  OPT_faux_classpath = 493,                  /* -faux-classpath */
  OPT_fbackslash = 494,                      /* -fbackslash */
  OPT_fbacktrace = 495,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 496,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 497,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 498,              /* -fbootstrap-classes */
  ...
  OPT_fcall_saved_ = 508,                    /* -fcall-saved- */
  OPT_fcall_used_ = 509,                     /* -fcall-used- */
  OPT_fcaller_saves = 510,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 511,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 512,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 513,                /* -fcheck-data-deps */
  OPT_fcheck_new = 514,                      /* -fcheck-new */
  OPT_fcheck_references = 515,               /* -fcheck-references */
  OPT_fcheck_ = 516,                         /* -fcheck= */
  OPT_fcilkplus = 517,                       /* -fcilkplus */
  OPT_fclasspath_ = 518,                     /* -fclasspath= */
  OPT_fcoarray_ = 519,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 520,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 521,                         /* -fcommon */
  OPT_fcompare_debug = 522,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 523,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 524,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 525,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 526,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 527,                  /* -fcond-mismatch */
  OPT_fconserve_space = 528,                 /* -fconserve-space */
  OPT_fconserve_stack = 529,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 530,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 531,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 532,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 533,          /* -fconvert=little-endian */
  OPT_fconvert_native = 534,                 /* -fconvert=native */
  OPT_fconvert_swap = 535,                   /* -fconvert=swap */
  OPT_fcprop_registers = 536,                /* -fcprop-registers */
  OPT_fcray_pointer = 537,                   /* -fcray-pointer */
  OPT_fcrossjumping = 538,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 539,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 540, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 541,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 542,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 543,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 544,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 545,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 546,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 547,                       /* -fdbg-cnt= */
  OPT_fdce = 548,                            /* -fdce */
  OPT_fdebug_cpp = 549,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 550,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 551,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 552,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 553,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 554,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 555, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 556,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 557,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 558,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 559,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 560,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 561,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 562,                   /* -fdevirtualize */
  OPT_fdevirtualize_speculatively = 563,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 564, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 565,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 566,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 567,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 568,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 569,                /* -fdirectives-only */
  OPT_fdisable_ = 570,                       /* -fdisable- */
  OPT_fdisable_assertions = 571,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 572,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 573,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 574,         /* -fdollars-in-identifiers */
  OPT_fdse = 575,                            /* -fdse */
  OPT_fdump_ = 576,                          /* -fdump- */
  OPT_fdump_ada_spec = 577,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 578,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 579, */                /* -fdump-core */
  OPT_fdump_final_insns = 580,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 581,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 582,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 583,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 584,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 585,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 586,                /* -fdump-parse-tree */
  OPT_fdump_passes = 587,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 588,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 589,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 590,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 591,                 /* -fearly-inlining */
  OPT_felide_constructors = 592,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 593,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 594, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 595,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 596,        /* -femit-class-debug-always */
  OPT_femit_class_file = 597,                /* -femit-class-file */
  OPT_femit_class_files = 598,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 599,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 600,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 601,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 602,                        /* -fenable- */
  OPT_fenable_assertions = 603,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 604,             /* -fenable-assertions= */
  OPT_fencoding_ = 605,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 606,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 607, */           /* -fenum-int-equiv */
  OPT_fexceptions = 608,                     /* -fexceptions */
  OPT_fexcess_precision_ = 609,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 610,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 611,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 612,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 613,                       /* -fextdirs= */
  OPT_fextended_identifiers = 614,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 615,                /* -fextern-tls-init */
  OPT_fexternal_blas = 616,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 617, */       /* -fexternal-templates */
  OPT_ff2c = 618,                            /* -ff2c */
  OPT_ffast_math = 619,                      /* -ffast-math */
  OPT_ffat_lto_objects = 620,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 621,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 622,               /* -ffinite-math-only */
  OPT_ffixed_ = 623,                         /* -ffixed- */
  OPT_ffixed_form = 624,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 625,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 626,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 627,                    /* -ffloat-store */
  OPT_ffor_scope = 628,                      /* -ffor-scope */
  /* OPT_fforce_addr = 629, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 630,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 631,              /* -fforward-propagate */
  OPT_ffp_contract_ = 632,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 633,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 634,                      /* -ffpe-trap= */
  OPT_ffree_form = 635,                      /* -ffree-form */
  OPT_ffree_line_length_ = 636,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 637,          /* -ffree-line-length-none */
  OPT_ffreestanding = 638,                   /* -ffreestanding */
  OPT_ffriend_injection = 639,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 640,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 641,                   /* -ffunction-cse */
  OPT_ffunction_sections = 642,              /* -ffunction-sections */
  OPT_fgcse = 643,                           /* -fgcse */
  OPT_fgcse_after_reload = 644,              /* -fgcse-after-reload */
  OPT_fgcse_las = 645,                       /* -fgcse-las */
  OPT_fgcse_lm = 646,                        /* -fgcse-lm */
  OPT_fgcse_sm = 647,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 648,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 649,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 650,                         /* -fgnu-tm */
  OPT_fgnu_unique = 651,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 652,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 653,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 654,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 655,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 656,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 657,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 658,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 659,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 660,                       /* -fgraphite */
  OPT_fgraphite_code_generator_ = 661,       /* -fgraphite-code-generator= */
  OPT_fgraphite_identity = 662,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 663,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 664, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 665, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 666,           /* -fhash-synchronization */
  /* OPT_fhelp = 667, */                     /* -fhelp */
  /* OPT_fhelp_ = 668, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 669,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 670, */                /* -fhonor-std */
  OPT_fhosted = 671,                         /* -fhosted */
  /* OPT_fhuge_objects = 672, */             /* -fhuge-objects */
  OPT_fident = 673,                          /* -fident */
  OPT_fif_conversion = 674,                  /* -fif-conversion */
  OPT_fif_conversion2 = 675,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 676,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 677,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 678,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 679,             /* -fimplicit-templates */
  OPT_findirect_classes = 680,               /* -findirect-classes */
  OPT_findirect_dispatch = 681,              /* -findirect-dispatch */
  OPT_findirect_inlining = 682,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 683,         /* -finhibit-size-directive */
  OPT_finit_character_ = 684,                /* -finit-character= */
  OPT_finit_integer_ = 685,                  /* -finit-integer= */
  OPT_finit_local_zero = 686,                /* -finit-local-zero */
  OPT_finit_logical_ = 687,                  /* -finit-logical= */
  OPT_finit_real_ = 688,                     /* -finit-real= */
  OPT_finline = 689,                         /* -finline */
  OPT_finline_atomics = 690,                 /* -finline-atomics */
  OPT_finline_functions = 691,               /* -finline-functions */
  OPT_finline_functions_called_once = 692,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 693, */            /* -finline-limit- */
  OPT_finline_limit_ = 694,                  /* -finline-limit= */
  OPT_finline_small_functions = 695,         /* -finline-small-functions */
  OPT_finput_charset_ = 696,                 /* -finput-charset= */
  OPT_finstrument_functions = 697,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 698,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 699,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 700,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 701,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 702,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 703,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 704,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 705, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 706,                    /* -fipa-profile */
  OPT_fipa_pta = 707,                        /* -fipa-pta */
  OPT_fipa_pure_const = 708,                 /* -fipa-pure-const */
  OPT_fipa_reference = 709,                  /* -fipa-reference */
  OPT_fipa_sra = 710,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 711, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 712,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 713,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 714,              /* -fira-loop-pressure */
  OPT_fira_region_ = 715,                    /* -fira-region= */
  OPT_fira_share_save_slots = 716,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 717,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 718,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 719,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 720,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 721,               /* -fivar-visibility= */
  OPT_fivopts = 722,                         /* -fivopts */
  OPT_fjni = 723,                            /* -fjni */
  OPT_fjump_tables = 724,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 725,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 726,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 727,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 728, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 729,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 730,             /* -fleading-underscore */
  OPT_flive_range_shrinkage = 731,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 732,                    /* -flocal-ivars */
  OPT_floop_block = 733,                     /* -floop-block */
  /* OPT_floop_flatten = 734, */             /* -floop-flatten */
  OPT_floop_interchange = 735,               /* -floop-interchange */
  OPT_floop_nest_optimize = 736,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 737, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 738,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 739,                /* -floop-strip-mine */
  OPT_flto = 740,                            /* -flto */
  OPT_flto_compression_level_ = 741,         /* -flto-compression-level= */
  OPT_flto_partition_ = 742,                 /* -flto-partition= */
  OPT_flto_report = 743,                     /* -flto-report */
  OPT_flto_report_wpa = 744,                 /* -flto-report-wpa */
  OPT_flto_ = 745,                           /* -flto= */
  OPT_fltrans = 746,                         /* -fltrans */
  OPT_fltrans_output_list_ = 747,            /* -fltrans-output-list= */
  OPT_fmain_ = 748,                          /* -fmain= */
  OPT_fmath_errno = 749,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 750,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 751,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 752,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 753,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 754,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 755,                     /* -fmem-report */
  OPT_fmem_report_wpa = 756,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 757,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 758,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 759,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 760,                /* -fmessage-length= */
  OPT_fmodule_private = 761,                 /* -fmodule-private */
  OPT_fmodulo_sched = 762,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 763,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 764,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 765,                  /* -fms-extensions */
  /* OPT_fmudflap = 766, */                  /* -fmudflap */
  /* OPT_fmudflapir = 767, */                /* -fmudflapir */
  /* OPT_fmudflapth = 768, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 769, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 770, */                  /* -fnew-abi */
  OPT_fnext_runtime = 771,                   /* -fnext-runtime */
  OPT_fnil_receivers = 772,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 773, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 774,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 775,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 776, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 777,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 778,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 779,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 780,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 781,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 782,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 783,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 784,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 785,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 786,             /* -fomit-frame-pointer */
  OPT_fopenmp = 787,                         /* -fopenmp */
  OPT_fopenmp_simd = 788,                    /* -fopenmp-simd */
  OPT_foperator_names = 789,                 /* -foperator-names */
  OPT_fopt_info = 790,                       /* -fopt-info */
  OPT_fopt_info_ = 791,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 792, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 793,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 794,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 795,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 796, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 797,              /* -foutput-class-dir= */
  OPT_fpack_derived = 798,                   /* -fpack-derived */
  OPT_fpack_struct = 799,                    /* -fpack-struct */
  OPT_fpack_struct_ = 800,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 801,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 802,              /* -fpcc-struct-return */
  OPT_fpch_deps = 803,                       /* -fpch-deps */
  OPT_fpch_preprocess = 804,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 805,                     /* -fpeel-loops */
  OPT_fpeephole = 806,                       /* -fpeephole */
  OPT_fpeephole2 = 807,                      /* -fpeephole2 */
  OPT_fpermissive = 808,                     /* -fpermissive */
  OPT_fpic = 809,                            /* -fpic */
  OPT_fpie = 810,                            /* -fpie */
  OPT_fplan9_extensions = 811,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 812,                    /* -fplugin-arg- */
  OPT_fplugin_ = 813,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 814,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 815,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 816,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 817,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 818,                   /* -fpreprocessed */
  OPT_fpretty_templates = 819,               /* -fpretty-templates */
  OPT_fprofile = 820,                        /* -fprofile */
  OPT_fprofile_arcs = 821,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 822,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 823,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 824,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 825,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 826,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 827,                 /* -fprofile-report */
  OPT_fprofile_use = 828,                    /* -fprofile-use */
  OPT_fprofile_use_ = 829,                   /* -fprofile-use= */
  OPT_fprofile_values = 830,                 /* -fprofile-values */
  OPT_fprotect_parens = 831,                 /* -fprotect-parens */
  OPT_frandom_seed = 832,                    /* -frandom-seed */
  OPT_frandom_seed_ = 833,                   /* -frandom-seed= */
  OPT_frange_check = 834,                    /* -frange-check */
  OPT_freal_4_real_10 = 835,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 836,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 837,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 838,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 839,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 840,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 841,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 842,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 843,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 844,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 845,                /* -frecord-marker=8 */
  OPT_frecursive = 846,                      /* -frecursive */
  OPT_freduced_reflection = 847,             /* -freduced-reflection */
  OPT_free = 848,                            /* -free */
  OPT_freg_struct_return = 849,              /* -freg-struct-return */
  /* OPT_fregmove = 850, */                  /* -fregmove */
  OPT_frename_registers = 851,               /* -frename-registers */
  OPT_freorder_blocks = 852,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 853,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 854,              /* -freorder-functions */
  OPT_frepack_arrays = 855,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 856,           /* -freplace-objc-classes */
  OPT_frepo = 857,                           /* -frepo */
  OPT_frequire_return_statement = 858,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 859,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 860, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 861,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 862,                    /* -fresolution= */
  OPT_frounding_math = 863,                  /* -frounding-math */
  OPT_frtti = 864,                           /* -frtti */
  OPT_fsanitize_recover = 865,               /* -fsanitize-recover */
  OPT_fsanitize_undefined_trap_on_error = 866,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 867,                      /* -fsanitize= */
  OPT_fsaw_java_file = 868,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 869,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 870,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 871,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 872,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 873,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 874,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 875,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 876,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 877,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 878,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 879,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 880,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 881,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 882,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 883,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 884,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 885,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 886, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 887,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 888,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 889,              /* -fsecond-underscore */
  OPT_fsection_anchors = 890,                /* -fsection-anchors */
  /* OPT_fsee = 891, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 892,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 893,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 894, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 895,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 896,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 897,         /* -fsemantic-interposition */
  OPT_fset_stack_executable = 898,           /* -fset-stack-executable */
  OPT_fshort_double = 899,                   /* -fshort-double */
  OPT_fshort_enums = 900,                    /* -fshort-enums */
  OPT_fshort_wchar = 901,                    /* -fshort-wchar */
  OPT_fshow_column = 902,                    /* -fshow-column */
  OPT_fshrink_wrap = 903,                    /* -fshrink-wrap */
  OPT_fsign_zero = 904,                      /* -fsign-zero */
  OPT_fsignaling_nans = 905,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 906,               /* -fsigned-bitfields */
  OPT_fsigned_char = 907,                    /* -fsigned-char */
  OPT_fsigned_zeros = 908,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 909,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 910,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 911,               /* -fsource-filename= */
  OPT_fsource_ = 912,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 913,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 914,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 915,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 916, */                 /* -fsquangle */
  OPT_fssa_phiopt = 917,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 918,                   /* -fstack-arrays */
  /* OPT_fstack_check = 919, */              /* -fstack-check */
  OPT_fstack_check_ = 920,                   /* -fstack-check= */
  OPT_fstack_limit = 921,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 922,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 923,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 924,                /* -fstack-protector */
  OPT_fstack_protector_all = 925,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 926,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 927,                   /* -fstack-reuse= */
  OPT_fstack_usage = 928,                    /* -fstack-usage */
  OPT_fstats = 929,                          /* -fstats */
  OPT_fstore_check = 930,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 931, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 932,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 933,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 934,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 935, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 936,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 937,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 938,                    /* -fsyntax-only */
  OPT_ftabstop_ = 939,                       /* -ftabstop= */
  /* OPT_ftarget_help = 940, */              /* -ftarget-help */
  OPT_ftarget_ = 941,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 942,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 943, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 944,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 945,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 946, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 947,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 948,             /* -fthreadsafe-statics */
  OPT_ftime_report = 949,                    /* -ftime-report */
  OPT_ftls_model_ = 950,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 951,               /* -ftoplevel-reorder */
  OPT_ftracer = 952,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 953,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 954,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 955,                  /* -ftrapping-math */
  OPT_ftrapv = 956,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 957,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 958,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 959,                       /* -ftree-ccp */
  OPT_ftree_ch = 960,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 961,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 962,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 963,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 964,                /* -ftree-copyrename */
  OPT_ftree_cselim = 965,                    /* -ftree-cselim */
  OPT_ftree_dce = 966,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 967,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 968,                       /* -ftree-dse */
  OPT_ftree_forwprop = 969,                  /* -ftree-forwprop */
  OPT_ftree_fre = 970,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 971,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 972,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 973,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 974,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 975,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 976,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 977, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 978,             /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 979,            /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 980,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 981,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 982,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 983,                   /* -ftree-phiprop */
  OPT_ftree_pre = 984,                       /* -ftree-pre */
  OPT_ftree_pta = 985,                       /* -ftree-pta */
  OPT_ftree_reassoc = 986,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 987, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 988,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 989,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 990,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 991,                      /* -ftree-slsr */
  OPT_ftree_sra = 992,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 993, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 994, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 995,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 996,                /* -ftree-tail-merge */
  OPT_ftree_ter = 997,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 998, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 999,                 /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1000, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1001,                      /* -ftree-vrp */
  OPT_funderscoring = 1002,                  /* -funderscoring */
  OPT_funit_at_a_time = 1003,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1004,              /* -funroll-all-loops */
  OPT_funroll_loops = 1005,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1006,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1007,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1008,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1009,                 /* -funsigned-char */
  OPT_funswitch_loops = 1010,                /* -funswitch-loops */
  OPT_funwind_tables = 1011,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1012,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1013,                  /* -fuse-boehm-gc */
  OPT_fuse_caller_save = 1014,               /* -fuse-caller-save */
  OPT_fuse_cxa_atexit = 1015,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1016,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1017,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1018,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1019,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1020,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1021,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1022,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1023,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1024,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1025,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1026, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1027,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1028,                   /* -fverbose-asm */
  /* OPT_fversion = 1029, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1030,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1031,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1032,                   /* -fvisibility= */
  OPT_fvpt = 1033,                           /* -fvpt */
  /* OPT_fvtable_gc = 1034, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1035, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1036,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1037,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1038,                     /* -fvtv-debug */
  OPT_fweak = 1039,                          /* -fweak */
  OPT_fweb = 1040,                           /* -fweb */
  /* OPT_fwhole_file = 1041, */              /* -fwhole-file */
  OPT_fwhole_program = 1042,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1043,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1044,             /* -fworking-directory */
  OPT_fwpa = 1045,                           /* -fwpa */
  OPT_fwpa_ = 1046,                          /* -fwpa= */
  OPT_fwrapv = 1047,                         /* -fwrapv */
  OPT_fwritable_relocated_rdata = 1048,      /* -fwritable-relocated-rdata */
  /* OPT_fxref = 1049, */                    /* -fxref */
  /* OPT_fzee = 1050, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1051,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1052,                     /* -fzero-link */
  OPT_g = 1053,                              /* -g */
  OPT_gant = 1054,                           /* -gant */
  OPT_gcoff = 1055,                          /* -gcoff */
  OPT_gdwarf = 1056,                         /* -gdwarf */
  OPT_gdwarf_ = 1057,                        /* -gdwarf- */
  OPT_gen_decls = 1058,                      /* -gen-decls */
  OPT_ggdb = 1059,                           /* -ggdb */
  OPT_ggnu_pubnames = 1060,                  /* -ggnu-pubnames */
  OPT_gnat = 1061,                           /* -gnat */
  OPT_gnatO = 1062,                          /* -gnatO */
  OPT_gno_pubnames = 1063,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1064,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1065,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1066,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1067,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1068,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1069,                   /* -gsplit-dwarf */
  OPT_gstabs = 1070,                         /* -gstabs */
  OPT_gstabs_ = 1071,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1072,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1073,                        /* -gtoggle */
  OPT_gvms = 1074,                           /* -gvms */
  OPT_gxcoff = 1075,                         /* -gxcoff */
  OPT_gxcoff_ = 1076,                        /* -gxcoff+ */
  OPT_gz = 1077,                             /* -gz */
  OPT_gz_ = 1078,                            /* -gz= */
  OPT_h = 1079,                              /* -h */
  OPT_idirafter = 1080,                      /* -idirafter */
  OPT_imacros = 1081,                        /* -imacros */
  OPT_imultiarch = 1082,                     /* -imultiarch */
  OPT_imultilib = 1083,                      /* -imultilib */
  OPT_include = 1084,                        /* -include */
  OPT_iplugindir_ = 1085,                    /* -iplugindir= */
  OPT_iprefix = 1086,                        /* -iprefix */
  OPT_iquote = 1087,                         /* -iquote */
  OPT_isysroot = 1088,                       /* -isysroot */
  OPT_isystem = 1089,                        /* -isystem */
  OPT_iwithprefix = 1090,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1091,              /* -iwithprefixbefore */
  OPT_k8 = 1092,                             /* -k8 */
  OPT_l = 1093,                              /* -l */
  OPT_lang_asm = 1094,                       /* -lang-asm */
  OPT_m128bit_long_double = 1095,            /* -m128bit-long-double */
  OPT_m16 = 1096,                            /* -m16 */
  OPT_m32 = 1097,                            /* -m32 */
  OPT_m3dnow = 1098,                         /* -m3dnow */
  OPT_m3dnowa = 1099,                        /* -m3dnowa */
  OPT_m64 = 1100,                            /* -m64 */
  OPT_m80387 = 1101,                         /* -m80387 */
  OPT_m8bit_idiv = 1102,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1103,             /* -m96bit-long-double */
  OPT_mabi_ = 1104,                          /* -mabi= */
  OPT_mabm = 1105,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1106,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1107,                 /* -maddress-mode= */
  OPT_madx = 1108,                           /* -madx */
  OPT_maes = 1109,                           /* -maes */
  OPT_malign_double = 1110,                  /* -malign-double */
  OPT_malign_functions_ = 1111,              /* -malign-functions= */
  OPT_malign_jumps_ = 1112,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1113,                  /* -malign-loops= */
  OPT_malign_stringops = 1114,               /* -malign-stringops */
  OPT_march_ = 1115,                         /* -march= */
  OPT_masm_ = 1116,                          /* -masm= */
  OPT_mavx = 1117,                           /* -mavx */
  OPT_mavx2 = 1118,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1119,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1120,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1121,                      /* -mavx512bw */
  OPT_mavx512cd = 1122,                      /* -mavx512cd */
  OPT_mavx512dq = 1123,                      /* -mavx512dq */
  OPT_mavx512er = 1124,                      /* -mavx512er */
  OPT_mavx512f = 1125,                       /* -mavx512f */
  OPT_mavx512pf = 1126,                      /* -mavx512pf */
  OPT_mavx512vl = 1127,                      /* -mavx512vl */
  OPT_mbmi = 1128,                           /* -mbmi */
  OPT_mbmi2 = 1129,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1130,                  /* -mbranch-cost= */
  OPT_mcld = 1131,                           /* -mcld */
  OPT_mclflushopt = 1132,                    /* -mclflushopt */
  OPT_mcmodel_ = 1133,                       /* -mcmodel= */
  OPT_mconsole = 1134,                       /* -mconsole */
  /* OPT_mcpu_ = 1135, */                    /* -mcpu= */
  OPT_mcrc32 = 1136,                         /* -mcrc32 */
  OPT_mcx16 = 1137,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1138,            /* -mdispatch-scheduler */
  OPT_mdll = 1139,                           /* -mdll */
  OPT_mdump_tune_features = 1140,            /* -mdump-tune-features */
  OPT_mf16c = 1141,                          /* -mf16c */
  OPT_mfancy_math_387 = 1142,                /* -mfancy-math-387 */
  OPT_mfentry = 1143,                        /* -mfentry */
  OPT_mfma = 1144,                           /* -mfma */
  OPT_mfma4 = 1145,                          /* -mfma4 */
  OPT_mforce_drap = 1146,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1147,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1148,                       /* -mfpmath= */
  OPT_mfsgsbase = 1149,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1150, */              /* -mfused-madd */
  OPT_mfxsr = 1151,                          /* -mfxsr */
  OPT_mhard_float = 1152,                    /* -mhard-float */
  OPT_mhle = 1153,                           /* -mhle */
  OPT_mieee_fp = 1154,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1155,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1156,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1157,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1158, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1159,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1160,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1161,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1162,                /* -mlong-double-80 */
  OPT_mlwp = 1163,                           /* -mlwp */
  OPT_mlzcnt = 1164,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1165,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1166,              /* -mmemset-strategy= */
  OPT_mmmx = 1167,                           /* -mmmx */
  OPT_mmovbe = 1168,                         /* -mmovbe */
  OPT_mms_bitfields = 1169,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1170,            /* -mno-align-stringops */
  OPT_mno_default = 1171,                    /* -mno-default */
  ...
  OPT_mnop_fun_dllimport = 1176,             /* -mnop-fun-dllimport */
  OPT_momit_leaf_frame_pointer = 1177,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1178,                          /* -mpc32 */
  OPT_mpc64 = 1179,                          /* -mpc64 */
  OPT_mpc80 = 1180,                          /* -mpc80 */
  OPT_mpclmul = 1181,                        /* -mpclmul */
  OPT_mpe_aligned_commons = 1182,            /* -mpe-aligned-commons */
  OPT_mpopcnt = 1183,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1184,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1185,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1186,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1187,                        /* -mprfchw */
  OPT_mpush_args = 1188,                     /* -mpush-args */
  OPT_mrdrnd = 1189,                         /* -mrdrnd */
  OPT_mrdseed = 1190,                        /* -mrdseed */
  OPT_mrecip = 1191,                         /* -mrecip */
  OPT_mrecip_ = 1192,                        /* -mrecip= */
  OPT_mred_zone = 1193,                      /* -mred-zone */
  OPT_mregparm_ = 1194,                      /* -mregparm= */
  OPT_mrtd = 1195,                           /* -mrtd */
  OPT_mrtm = 1196,                           /* -mrtm */
  OPT_msahf = 1197,                          /* -msahf */
  OPT_msha = 1198,                           /* -msha */
  OPT_msoft_float = 1199,                    /* -msoft-float */
  OPT_msse = 1200,                           /* -msse */
  OPT_msse2 = 1201,                          /* -msse2 */
  OPT_msse2avx = 1202,                       /* -msse2avx */
  OPT_msse3 = 1203,                          /* -msse3 */
  OPT_msse4 = 1204,                          /* -msse4 */
  OPT_msse4_1 = 1205,                        /* -msse4.1 */
  OPT_msse4_2 = 1206,                        /* -msse4.2 */
  OPT_msse4a = 1207,                         /* -msse4a */
  /* OPT_msse5 = 1208, */                    /* -msse5 */
  OPT_msseregparm = 1209,                    /* -msseregparm */
  OPT_mssse3 = 1210,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1211,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1212,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1213,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1214,            /* -mstringop-strategy= */
  OPT_mtbm = 1215,                           /* -mtbm */
  OPT_mthreads = 1216,                       /* -mthreads */
  OPT_mtls_dialect_ = 1217,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1218,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1219,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1220,                         /* -mtune= */
  OPT_municode = 1221,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1222,          /* -muse-libstdc-wrappers */
  OPT_mveclibabi_ = 1223,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1224,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1225,                    /* -mvzeroupper */
  OPT_mwin32 = 1226,                         /* -mwin32 */
  OPT_mwindows = 1227,                       /* -mwindows */
  OPT_mx32 = 1228,                           /* -mx32 */
  OPT_mxop = 1229,                           /* -mxop */
  OPT_mxsave = 1230,                         /* -mxsave */
  OPT_mxsavec = 1231,                        /* -mxsavec */
  OPT_mxsaveopt = 1232,                      /* -mxsaveopt */
  OPT_mxsaves = 1233,                        /* -mxsaves */
  OPT_n = 1234,                              /* -n */
  OPT_no_canonical_prefixes = 1235,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1236,              /* -no-integrated-cpp */
  OPT_no_pthread = 1237,                     /* -no-pthread */
